...
//OJO ver que gpio se puede usar
#define  A0_PORT_NUM 0	//Expansion 0     en el tft es DC
#define  A0_BIT_NUM 22//10					//en el tft es DC
#define  RST_PORT_NUM 0	//Expansion 1
#define  RST_BIT_NUM 21//0
#define  CS_PORT_NUM 0	//Expansion 0     en el tft es CS
#define  CS_BIT_NUM 6//1
